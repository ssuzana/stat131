...
subtitle: 'Lecture 7: Covariance, correlation, and transformations'
...
```{r echo=FALSE, figures-side1, fig.show="hold", out.width="30%", fig.height=6, fig.width=8}
x <- seq(0, 1, length=100)
plot(x, dbeta(x, 1, 1), type="l", lty=2, xlab="x",
  ylab="f(x)", main="PDF: Beta(1,1)", ylim=c(0,5))
plot(x, dbeta(x, 1/2, 1/2), type="l", lty=2, xlab="x",
   ylab="f(x)", main="PDF: Beta(1/2,1/2)", ylim=c(0,5))
plot(x, dbeta(x, 1/2, 1), type="l", lty=2, xlab="x",
   ylab="f(x)", main="PDF: Beta(1/2,1)", ylim=c(0,5))
plot(x, dbeta(x, 1, 1/2), type="l", lty=2, xlab="x",
   ylab="f(x)", main="PDF: Beta(1,1/2)", ylim=c(0,5))
plot(x, dbeta(x, 2, 1), type="l", lty=2, xlab="x",
   ylab="f(x)", main="PDF: Beta(2,1)", ylim=c(0,5))
plot(x, dbeta(x, 5, 5), type="l", lty=2, xlab="x",
   ylab="f(x)", main="PDF: Beta(5,5)", ylim=c(0,5))
